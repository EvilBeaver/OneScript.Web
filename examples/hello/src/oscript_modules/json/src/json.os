...
Функция ВырезатьКомментарии( Знач пТекст )
	...
	Пока СтрНайти( ЗначениеБезКомментариев, Символы.ПС + Символы.ПС ) > 0 Цикл
		ЗначениеБезКомментариев = СтрЗаменить( ЗначениеБезКомментариев, Символы.ПС + Символы.ПС, Символы.ПС )
	КонецЦикла;
