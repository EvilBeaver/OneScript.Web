...
Процедура Инициализация() Экспорт
	...
	ИнформационнаяБаза.ТипСУБД = ИнформационнаяБаза.ТипыСУБД.sqlite;
	ИнформационнаяБаза.ИмяБазы = ":memory:";
	ИнформационнаяБаза.Открыть();
	ИнформационнаяБаза.ВыполнитьКоманду("Create table goods (id INTEGER PRIMARY KEY, name TEXT, article TEXT, price double, description TEXT)");
...
Функция ДобавитьНоменклатуру(Данные) Экспорт
	...
	Запрос = ИнформационнаяБаза.СоздатьЗапрос();
